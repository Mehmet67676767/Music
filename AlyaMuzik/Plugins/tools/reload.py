...
from AlyaMuzik.utils.database import get_authuser_names, get_cmode
from AlyaMuzik.utils.decorators import ActualAdminCB, AdminActual, language
from AlyaMuzik.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Alya.stop_stream(message.chat.id)
    except:
        pass
